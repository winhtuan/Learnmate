    ...
    public partial class SeedStudent3ClassData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 2L, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Cross-Platform Mobile App Development With .NET MAUI", 30, "PRN222", "PRN222", 2L, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc) },
                    { 3L, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Unity Game Development — Scripting & Physics", 30, "PRU213", "PRU213", 2L, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc) }
                });
            ...
            migrationBuilder.InsertData(
                table: "assignments",
                columns: new[] { "id", "class_id", "created_at", "deleted_at", "description", "due_date", "status", "teacher_id", "title", "updated_at" },
                values: new object[,]
                {
                    { 1L, 2L, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Xây dựng ứng dụng MAUI có ít nhất 3 màn hình với Shell Navigation và truyền dữ liệu giữa các trang.", new DateTime(2026, 3, 16, 16, 59, 0, 0, DateTimeKind.Utc), "PUBLISHED", 2L, "Lab 1: MAUI Navigation", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc) },
                    { 2L, 3L, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Tạo một scene Unity có ánh sáng directional, mặt phẳng (Plane), và ít nhất 1 GameObject có Rigidbody và Collider.", new DateTime(2026, 3, 15, 16, 59, 0, 0, DateTimeKind.Utc), "PUBLISHED", 2L, "Lab 1: Unity Scene", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc) }
                });
            ...
            migrationBuilder.InsertData(
                table: "materials",
                columns: new[] { "id", "class_id", "created_at", "description", "file_type", "file_url", "title", "updated_at", "uploaded_by" },
                values: new object[,]
                {
                    { 1L, 2L, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Tổng quan về .NET MAUI, XAML cơ bản và cấu trúc project.", "PDF", "https://storage.learnmate.vn/materials/prn222-slide-01.pdf", "Slide Buổi 1 — .NET MAUI Introduction", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 2L },
                    { 2L, 3L, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Hướng dẫn cài đặt Unity Hub, tạo project và làm quen với Editor.", "PDF", "https://storage.learnmate.vn/materials/pru213-slide-01.pdf", "Slide Buổi 1 — Unity Editor Overview", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 2L }
                });
