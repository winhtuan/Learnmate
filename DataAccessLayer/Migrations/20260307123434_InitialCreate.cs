...
namespace DataAccessLayer.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    grade_level = table.Column<string>(
                        type: "character varying(20)",
                        maxLength: 20,
                        nullable: true
                    ),
                    parent_contact = table.Column<string>(
                        type: "character varying(20)",
                        maxLength: 20,
                        nullable: true
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    subjects = table.Column<string>(
                        type: "character varying(500)",
                        maxLength: 500,
                        nullable: false
                    ),
                    hourly_rate = table.Column<decimal>(type: "numeric(12,2)", nullable: false),
                    rating_avg = table.Column<decimal>(
                        type: "numeric(5,2)",
                        nullable: false,
                        defaultValue: 0m
                    ),
                    total_rating_count = table.Column<int>(
                        type: "integer",
                        nullable: false,
                        defaultValue: 0
                    ),
                    bank_account = table.Column<string>(
                        type: "character varying(100)",
                        maxLength: 100,
                        nullable: true
                    ),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint(
                        "ck_teacher_profiles_rating_avg",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    meeting_url = table.Column<string>(
                        type: "character varying(500)",
                        maxLength: 500,
                        nullable: false
                    ),
                    meeting_id = table.Column<string>(
                        type: "character varying(100)",
                        maxLength: 100,
                        nullable: true
                    ),
                ...
                {
                    {
                        ...
                        "admin@learnmate.vn",
                        true,
                        "$2a$12$BgRmemonnrWXu0O0hABfSuRgIBIjUevBcIGTk53b.y0oPqW45tCka",
                        "ADMIN",
                        new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                    },
                    {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[]
                {
                    ...
                    new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                    null,
                    "Ôn luyện toàn bộ chương trình Toán lớp 12.",
                    20,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[]
                {
                    ...
                    null,
                    null,
                    "Giáo viên Toán với 5 năm kinh nghiệm.",
                    new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                    "Nguyen Van A",
                    200000m,
                    "Toán, Vật Lý",
        ...
        {
            migrationBuilder.DropTable(name: "class_members");
            ...
            migrationBuilder.DropTable(name: "otp_verifications");

            migrationBuilder.DropTable(name: "payments");

            migrationBuilder.DropTable(name: "student_profiles");

            migrationBuilder.DropTable(name: "submission_answer_options");

            migrationBuilder.DropTable(name: "teacher_profiles");

            migrationBuilder.DropTable(name: "teacher_ratings");

            migrationBuilder.DropTable(name: "video_sessions");

            migrationBuilder.DropTable(name: "invoices");

            migrationBuilder.DropTable(name: "assignment_options");

            migrationBuilder.DropTable(name: "submission_answers");

            migrationBuilder.DropTable(name: "schedules");

            migrationBuilder.DropTable(name: "assignment_questions");
