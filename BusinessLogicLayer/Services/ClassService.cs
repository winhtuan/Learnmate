...
public class ClassService(IClassRepository classRepo) : IClassService
{
    ...
    public async Task<TeacherClassDetailDto?> GetTeacherClassDetailAsync(
        long classId, long teacherId, CancellationToken ct = default)
    {
        ...
        return new TeacherClassDetailDto
        {
            ...
            Students = cls.ClassMembers.Select(m => new TeacherStudentItemDto
            {
            ...
            Assignments = cls.Assignments.Select(a => new TeacherAssignmentItemDto
            {
                Id          = a.Id,
                Title       = a.Title,
            ...
            Materials = cls.Materials.Select(m => new TeacherMaterialItemDto
            {
                Id          = m.Id,
                Title       = m.Title,
